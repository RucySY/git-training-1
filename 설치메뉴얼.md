...
### 1. JDK 설치 및 JAVA_HOME 환경 변수 설정
 ...
 3. JAVA_HOME 환경 변수 설정
    ...
    - 고급 탭 > 환경변수 > 시스템 변수 창에서 새로 만들기 클릭 > 2에서 복사해둔 경로를 이용해 JAVA_HOME 환경 변수 만들기
![image6](./img/image6.png)
     <img src="/img/image5.png"  width="60%" height="60%">
  4. Path 환경 변수 설정
    - 시스템 변수 창에서 Path 변수를 클릭 > 편집 > %JAVA_HOME%\bin; 경로 붙여넣기 > 확인
    <img src="./img/image6.png"  width="60%" height="60%">
...
### 6. jd_gui 설치
 ...
 3. jd-gui.exe 실행(따로 설치 필요 없음)
  <img src="/img/image7.png"  width="50%" height="50%">
 <실행 화면>
